...
> 🖼️ **[그림 1]** — SEO/AEO/GEO 3원 벤다이어그램 (Cowork: §부록 A 참고, 직접 제작 권장)

---

## 2. 2026 트렌드 — 반드시 알아야 할 5가지 결론

> 🖼️ **[그림 2]** — "AI Overview 인용률 × 오가닉 순위" 막대그래프 (Ahrefs). 1위 ≈ 50%, 10위로 갈수록 급감. 출처: ahrefs.com/blog/llm-visibility
...
> 🖼️ **[그림 3]** — 8원 다이어그램 2행 배치

```
[1] 알고리즘   [2] 시장조사(경쟁사 키워드 추출)   [3] 도메인·호스팅   [4] CMS
[5] 검색엔진 등록   [6] 외부유입(백링크)   [7] 콘텐츠 발행   [8] 성과측정 시스템
```
...
- **이미지**: 아래 자리표시자에 맞춰 삽입. **타사 강의 캡처(어바웃피싱·Ubersuggest·타사 robots 등)는 저작권 이슈로 그대로 싣지 말고, 개념 다이어그램으로 재제작** 권장.

| 자리 | 내용 | 소스 방침 |
|---|---|---|
| [그림 1] | SEO/AEO/GEO 벤다이어그램 | **신규 제작** |
| [그림 2] | AI Overview 인용률×순위 막대 | 개념 재제작(수치 인용 가능, 캡처 지양) |
| [그림 3] | 8요소 파이프라인 | **신규 제작** |
| [그림 4] | 시놀 5채널 신호등(SEO주의·ASO위험·AEO양호·GEO주의·UX위험) | **신규 제작**(정본 값) |
| [그림 5] | 시놀 실행 로드맵 0→4 스텝퍼 | **신규 제작** |
